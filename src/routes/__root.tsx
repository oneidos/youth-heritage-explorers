    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-border bg-card px-5 py-2.5 text-sm font-semibold text-foreground transition-colors hover:bg-accent"
          >
            Torna all'inizio
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Cicero — scopri l'Italia con chi la vive" },
      {
        name: "description",
        content:
          "Cicero mette in contatto studenti: chi vuole scoprire una città e chi ci vive e la racconta.",
      },
